          ...
          <div className="grid grid-cols-1 gap-2 text-center">
            {prismicH.isFilled.richText(name) && (
              <Heading>
                ...
                <p className="font-serif text-3xl leading-normal tracking-tight text-zinc-100">
            ...
            {prismicH.isFilled.richText(description) && (
              <p className="font-serif text-2xl italic leading-normal tracking-tight text-zinc-400">
...
const NavItem = ({ children }) => {
  return (
    <li className="font-semibold tracking-tight text-zinc-100">{children}</li>
  );
};
